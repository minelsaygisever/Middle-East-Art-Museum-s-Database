<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="DeleteShop.aspx.cs" Inherits="MEAM_Database_Management.DeleteShop" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <h3>Enter the Shop Name.</h3>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <a href="DeleteShop.aspx">Refresh Page</a>
    </div>
</asp:Content>
