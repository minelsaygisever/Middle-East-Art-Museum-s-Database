...
{
    public partial class InsertClothes : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sqlStrPiece = "INSERT INTO Piece_T (PieceNumber, PieceName, PieceDescription, YearOfMade, EntryDay, EntryMonth, EntryYear, EntryHour, CountryOfOrigin, PersonalID, PieceType) VALUES("
                + pNumber + ", '" + pName + "', ";
            string sqlStrClothes = "INSERT INTO Clothes_T (CPieceNumber, Category, ClothesOwner) VALUES(" + pNumber + ", '" + category + "', ";
            string sqlStrClothesMaterials;
            ...
            {
                sqlStrClothes += "'" + TextBoxOwner.Text + "');";
            ...
            SqlCommand execTools = new SqlCommand(sqlStrClothes, con);
            ...
            using (StringReader reader = new StringReader(materials))
            {
                ...
                {
                    sqlStrClothesMaterials = "INSERT INTO Clothes_Materials_T (CPieceNumber, Material) VALUES(" + pNumber + ", '" + line + "');";
                    SqlDataAdapter adapter3 = new SqlDataAdapter();
                    SqlCommand execTMat = new SqlCommand(sqlStrClothesMaterials, con);
                    adapter3.InsertCommand = new SqlCommand(sqlStrClothesMaterials, con);
            ...
            sqlstr = "select * from Clothes_Materials_T";
            da = new SqlDataAdapter(sqlstr, con);
            da.Fill(ds3);
