...
namespace MEAM_Database_Management
{
    public partial class DeleteTools : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sqlstr2 = "select * from Tools_T where TPieceNumber=" + TextBox1.Text;
            ...
            String sql = "Delete from Tools_Materials_T where TPieceNumber=" + TextBox1.Text;
            ...
            String sql1 = "Delete from Tools_T where TPieceNumber=" + TextBox1.Text;
