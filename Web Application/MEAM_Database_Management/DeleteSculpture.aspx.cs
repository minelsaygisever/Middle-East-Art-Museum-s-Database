...
{
    public partial class DeleteSculpture : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sqlstr2 = "select * from Sculpture_T where SPieceNumber=" + TextBox1.Text;
            ...
            String sql = "Delete from Sculpture_T where SPieceNumber=" + TextBox1.Text;
