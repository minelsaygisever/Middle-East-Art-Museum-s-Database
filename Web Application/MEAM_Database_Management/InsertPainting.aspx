<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="InsertPainting.aspx.cs" Inherits="MEAM_Database_Management.InsertPainting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <br />
        Painter =
        <asp:TextBox ID="TextBoxPainter" runat="server" required="required"></asp:TextBox>
        Width =
        <asp:TextBox ID="TextBoxWidth" runat="server"></asp:TextBox>
        Height =
        <asp:TextBox ID="TextBoxHeight" runat="server"></asp:TextBox>
        Paint Type =
        <asp:TextBox ID="TextBoxPaintType" runat="server"></asp:TextBox>
        <p>
  ...
  <p>
    ...
    <div>
        ...
        <a href="InsertPainting.aspx">Refresh Page</a>
    </div>
</asp:Content>
