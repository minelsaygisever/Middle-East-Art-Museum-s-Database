...
<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="DeleteEmployee.aspx.cs" Inherits="MEAM_Database_Management.DeleteEmployee" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <h3>Enter the Personal ID.</h3>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <a href="DeleteEmployee.aspx">Refresh Page</a>
    </div>
</asp:Content>
