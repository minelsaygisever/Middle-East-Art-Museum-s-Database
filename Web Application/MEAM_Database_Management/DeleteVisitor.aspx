<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="DeleteVisitor.aspx.cs" Inherits="MEAM_Database_Management.DeleteVisitor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <h3>Enter the Visitor Number.</h3>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <a href="DeleteVisitor.aspx">Refresh Page</a>
    </div>
</asp:Content>
